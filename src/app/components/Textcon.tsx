...
function Textcon() {
  return (
    <>
    <div className='container justify-center mx-auto  px-5 py-5 items-center'>
        <div className='flex flex-col md:flex-row'>
            <p className='basis-3/4 text-3xl justify-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, debitis et! Reprehenderit laboriosam aut, consequatur quibusdam optio iusto nobis doloribus delectus esse. Harum magnam molestias et doloremque praesentium ea ducimus earum labore. Assumenda in tempora quis, adipisci libero facere voluptas a eum nostrum veniam deleniti? Deserunt, eligendi ab consequuntur quas saepe eaque quis amet laudantium fugiat dignissimos, recusandae pariatur, distinctio incidunt doloremque cum labore illo ea ad. Consequuntur in repudiandae veritatis aliquam repellendus reiciendis mollitia quas, corrupti adipisci maxime quidem temporibus cumque? Error perferendis pariatur deleniti non et? Assumenda non quaerat quisquam ut debitis odit consectetur ipsum animi explicabo itaque.</p>
