  ...
  return (
   ...
   <div className="container relative flex items-center justify-center flex-col">
    ...
    <div className="text-center items-center justify-center absolute sm:w-4/5 w-screen">
      <h1 className="title-font sm:text-6xl text-xl  font-medium text-slate-200">OPScraft is the Last thing you ever need in <span className='text-[#00df9a]'>Artificial Intelligence</span></h1>
